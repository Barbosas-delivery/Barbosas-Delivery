...
test("versão final consistente", () => {
  assert.match(constantsSource, /APP_VERSION = "6\.0\.41-fase-54-electron-basico"/);
  assert.match(serviceWorkerSource, /barbosas-delivery-6-0-41-fase-54-electron-basico-sem-cache/);
  ...
  const stockMigrationSource = readFileSync(new URL("../supabase/migracao-final-producao-6-0-41.sql", import.meta.url), "utf8");
