...
function sanitizeStoreSettings(settings = {}) {
  ...
  return {
    ...
    storeShortName: String(source.storeShortName || source.storeName || initialStoreSettings.storeShortName || initialStoreSettings.storeName).trim(),
    storeSlogan: String(source.storeSlogan || initialStoreSettings.storeSlogan || "").trim(),
    storeLogoUrl: String(source.storeLogoUrl || source.logoUrl || initialStoreSettings.storeLogoUrl || "").trim(),
    storeCoverUrl: String(source.storeCoverUrl || source.coverUrl || initialStoreSettings.storeCoverUrl || "").trim(),
    receiptBrandName: String(source.receiptBrandName || source.storeName || initialStoreSettings.receiptBrandName || initialStoreSettings.storeName).trim(),
    receiptLogoEnabled: source.receiptLogoEnabled !== false,
