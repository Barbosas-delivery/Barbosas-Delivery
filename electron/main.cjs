...
const APP_VERSION = "6.0.60-fase-72-reteste-operacional-completo";
...
function getDesktopInstallChecklist(config = DEFAULT_CONFIG) {
  return [
    { id: "version", label: "Versão desktop instalada", ok: APP_VERSION.includes("6.0.60"), detail: APP_VERSION },
