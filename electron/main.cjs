...
const APP_VERSION = "6.0.56-fase-68-teste-operacional-completo";
...
function getDesktopInstallChecklist(config = DEFAULT_CONFIG) {
  return [
    { id: "version", label: "Versão desktop instalada", ok: APP_VERSION.includes("6.0.56"), detail: APP_VERSION },
