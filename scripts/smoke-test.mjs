...
test("versão final consistente", () => {
  assert.match(constantsSource, /APP_VERSION = "6\.0\.57-fase-69-cadastro-real-adicionais"/);
  assert.match(serviceWorkerSource, /barbosas-delivery-6-0-57-fase-69-cadastro-real-adicionais-sem-cache/);
