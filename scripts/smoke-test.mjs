...
test("versão final consistente", () => {
  assert.match(constantsSource, /APP_VERSION = "6\.0\.64-fase-84-producao-limpa-final"/);
  assert.match(serviceWorkerSource, /barbosas-delivery-6-0-64-fase-84-producao-limpa-final-sem-cache/);
