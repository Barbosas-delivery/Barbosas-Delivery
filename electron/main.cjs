...
const APP_VERSION = "6.0.54-fase-66-lanchonete-pro-comandas-pdv";
...
function getDesktopInstallChecklist(config = DEFAULT_CONFIG) {
  return [
    { id: "version", label: "Versão desktop instalada", ok: APP_VERSION.includes("6.0.54"), detail: APP_VERSION },
