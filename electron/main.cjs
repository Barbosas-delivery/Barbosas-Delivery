...
const APP_VERSION = "6.0.55-fase-67-testes-funcionais-completos";
...
function getDesktopInstallChecklist(config = DEFAULT_CONFIG) {
  return [
    { id: "version", label: "Versão desktop instalada", ok: APP_VERSION.includes("6.0.55"), detail: APP_VERSION },
